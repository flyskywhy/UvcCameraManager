...
class Device extends PureComponent {
    ...
    constructor(props) {
        ...
        this.checkedLabel = [];
        this.state = {
            name: props.navigation.state.params.data.c_client_config ? props.navigation.state.params.data.c_client_config.name : '',
    ...
    _onConfigPress = () => {
        ...
        this.showLoadingModal();
        actions.configDev(id, this.state, this.checkedLabel, (device) => {
            this.dismissLoadingModal();
            actions.updateDevices();
            actions.toast('配置成功');
            navigation.goBack();
