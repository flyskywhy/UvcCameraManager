...
class LoginResetPasswd extends PureComponent {
    ...
    _onGetVcodePress = () => {
        ...
        actions.checkUserExistence(phone, () => {
            actions.getUserForgetPasswdVerification(phone, () => {
    ...
    _onResetUserPwd = () => {
        ...
        actions.resetUserPasswd({
            ...
            rejected: error => {
                this.dismissLoadingModal();
                error.res.json && error.res.json().then(result => actions.toast(result.err)).catch(() => {});
            }
        });
    }
    ...
    _onLoginPress = () => {
        ...
        this.showLoadingModal();
        actions.login(this.forgetPwdView.getPhone(), this.forgetPwdView.getPassword(), () => {
            this.dismissLoadingModal();
            actions.toast('登录成功');
            ...
            this.dismissLoadingModal();
            error.res.json && error.res.json().then(result => actions.toast(result.data)).catch(() => {});
        });
    }
                        ...
                        <View style={styles.container}>
                            <View style={styles.loginResetPwdView}>
                                ...
                                <TouchableOpacity
                                    ...
                                    <Text style={styles.resetUserPwdButtonText}>
                                        确 认
                                    </Text>
                                </TouchableOpacity>
                            </View>
