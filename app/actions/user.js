...
export const loginCode = createAction(
  types.LOGIN_CODE,
  async (username, verifycode) => {
...
export const getVcode = createAction(
  types.GET_VCODE,
  async (phone) => {
...
export const getLoginVerification = createAction(
  types.GET_LOGIN_VERIFICATION,
  async (mobile) => {
...
export const getBindPhoneSend = createAction(
  types.GET_BIND_PHONE_SEND,
  userService.getBindPhoneSend,
  ({resolved, rejected}) => {
    return {
      resolved,
      rejected,
...
export const getUserChangeDevOwnerVerification = createAction(
  types.GET_USER_CHANGE_DEV_OWNER_VERIFICATION,
  async (phone) => {
...
export const getUserForgetPasswdVerification = createAction(
  types.GET_USER_FORGETPASSWD_VERIFICATION,
  async (phone) => {
...
export const register = createAction(
  types.REGISTER,
  async (phone, password, verifCode) => {
...
export const getBindPhoneVerify = createAction(
  types.GET_BIND_PHONE_VERIFY,
  userService.getBindPhoneVerify,
  ({resolved, rejected}) => {
    return {
      resolved,
      rejected,
...
export const checkLogin = createAction(
  ...
  async () => {
    ...
    const user = await userService.getUserInfo(userId.id).then((userInfo) => {
      return {
...
export const updateClientUserInfo = createAction(
  types.UPDATE_CLIENT_USER_INFO,
  async (user) => {
    return await userService.getUserInfo(user.secret.id).then((userInfo) => {
      if (userInfo) {
        return userInfo;
      } else {
...
export const getUserInfo = createAction(
  types.GET_USER_INFO,
  async (userId) => {
    return await userService.getUserInfo(userId).then((userInfo) => {
      if (userInfo) {
        return userInfo;
      } else {
        throw 'getUserInfoError';
...
export const changeUserPasswd = createAction(
  types.CHANGE_USER_PASSWD,
  userService.changeUserPasswd,
  ({resolved, rejected}) => {
    return {
      resolved,
      rejected,
...
export const resetUserPasswd = createAction(
  types.RESET_USER_PASSWD,
  userService.resetUserPasswd,
  ({resolved, rejected}) => {
    return {
      resolved,
      rejected,
...
export const changeUserAddr = createAction(
  types.CHANGE_USER_ADDR,
  userService.changeUserAddr,
  ({resolved, rejected}) => {
    return {
      resolved,
      rejected,
...
export const logoutBackend = createAction(
  types.LOGOUT_BACKEND,
  userService.logoutBackend,
  ({resolved, rejected}) => {
    return {
      resolved,
      rejected,
...
export const getBackendVersion = createAction(
  types.GET_BACKEND_VERSION,
  userService.getBackendVersion,
  ({resolved, rejected}) => {
    return {
      resolved,
      rejected,
