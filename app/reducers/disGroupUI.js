    ...
    switch (type) {
        ...
        case types.UPDATA_GROUP_SCREEN:
            return {
                ...
                flagGroupScreen: (!error && !pending) ? state.flagGroupScreen + 1 : state.flagGroupScreen
            };
        case types.GET_GROUP_SCREEN:
            return {
                ...state,
                reachedEndPendingGroupScreen: pending,
                pageGroupScreen: (!error && !pending) ? state.pageGroupScreen + 1 : state.pageGroupScreen
            };
