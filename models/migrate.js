...
var modulesList = [
  ...
  },
  {
    ...
    program_addr:
      api.apiPath + api.userChangeDevOwnerVerificationPUT.path + '.*',
    method: 'put',
  ...
  },
  {
    ...
    name: '终止节目分组发布或发布到屏',
    program_addr:
      '/api/v0001/users/[0-9]*/programs/[0-9]*/publication/deletion',
    method: 'post',
    roles: [
      SUPER_ADMINER_ROLE_ID,
      ROLE_OWNER_ID,
  ...
  },
  {
    ...
    program_addr:
      '/api/v0001/users/[0-9]*/dispGroups/[0-9]*/dispSlots/addition',
    method: 'put',
    roles: [
      SUPER_ADMINER_ROLE_ID,
      ROLE_OWNER_ID,
  ...
  },
  {
    ...
    program_addr:
      '/api/v0001/users/[0-9]*/dispGroups/[0-9]*/dispSlots/deletion',
    method: 'put',
    roles: [
      SUPER_ADMINER_ROLE_ID,
      ROLE_OWNER_ID,
...
function* removeForeignKey(tableName, columnName, t) {
  var constraint = yield showForeignKey(
    cfg.db.database,
    tableName,
    columnName,
    t,
...
function* removeIndex(tableName, columnName) {
  ...
  for (var i = 0; i < idx.length; i++) {
    if (idx[i].name === columnName) {
      yield queryInterface.removeIndex(tableName, columnName);
