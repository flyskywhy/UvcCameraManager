...
module.exports = {
  ...
  dispGroupsGET: {
    /*获取分组信息:分组名字及组下逻辑屏数目*/ method: 'get',
  ...
  dispGroupsScreensGET: {
    /*获取组的具体逻辑屏信息*/ method: 'get',
  ...
  dispGroupsScreensDetailsGET: {
    /*获取组的逻辑屏下的显示槽信息*/ method: 'get',
  ...
  userUploadGET: {
    // 通过MD5 获得当前文件的状态，要求userUploadPOST之前调用
    path: '/upload/MD5/:md5',
    // params: {
    //     md5: ''
    // },
  ...
  userChangeDevOwnerVerificationPUT: {
    // 用户转让设备所有者获取短信验证码
  ...
  userForgetPasswdVerificationPUT: {
    // 用户通过手机号码获取忘记密码验证码
