...
module.exports.redisConnection = function(redisDb) {
    ...
    client.on('connect', function() {
        log.info("Redis default connection open to " + globalConfig.redis.host + ":" + globalConfig.redis.port);
    });

    client.on('error', function(err) {
        log.info("Redis default connection error " + err);
        log.info("Redis Path : " + globalConfig.redis.host + ":" + globalConfig.redis.port);
    });
