...
module.exports = (router) => {
    ...
    function* _registerDevice(userId, params, body, t) {
        ...
        if (findClient && findClient.c_client_list.status === moduleStatus.clients.pending.val) {
        ...
        //无效设备
        else if ((findClient && findClient.c_client_list.status === moduleStatus.clients.deleted.val)) {
    ...
    function* registerDevice() {
        ...
        this.log.info('registerDevPOST: From', this.request.host, 'params: ', params, 'body:', body);
    ...
    function* destroyDevice() {
        ...
        this.log.info('destroyDevDELETE: From', this.request.host,
            'params: ', this.params);
    ...
    function* getDeviceList() {
        ...
        var ndata = yield clientsTbl.findAll({
            ...
            'include': [{
                ...
                attributes: [
                    'id', 'x0', 'y0', 'width', 'height', 'status',
                    'b_mode_id', 'match_method', 'cycle'
                ]
            }]
        });
        ...
        for (; i1 < len; ++i1) {
            ...
            if (ndata[i1].dataValues.c_client_attribute !== null) {
                ndata[i1].dataValues.passward = ndata[i1].dataValues.c_client_attribute.dataValues.password;
            } else {
            ...
            ndata[i1].dataValues.active = yield devCtrl.getDevActiveStatus(ndata[i1].id);
        }
