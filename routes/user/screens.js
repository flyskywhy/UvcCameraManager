...
module.exports = (router) => {
  ...
  router.get(api.apiPath + api.userScreenListGET.path, function* () {
    ...
    try {
      ...
      log.debug(
        ' scns in groups:' + scnsInGroups,
        ' len=' + scnsInGroups.length,
      );
    } catch (err) {
  ...
  router.get(api.apiPath + api.publishedScreensGET.path, function* () {
    ...
    var ret = yield scnMisc.queryScreens(
      user,
      scnMisc.scn_query.publishedScns,
      cond,
    );
  ...
  router.get(api.apiPath + api.unpublishedScreensGET.path, function* () {
    ...
    var ret = yield scnMisc.queryScreens(
      user,
      scnMisc.scn_query.unpublishedScns,
      cond,
    );
